...
function UseCase() {
  return (
    <>
      <PageIntro eyebrow="Use Cases" title="AI that amplifies human creativity">
        <p className="text-muted-foreground">
          Pretty soon, most of what you see online will be generated by AI. It
          will get harder for visionary creators like you to stand out. With And
          Voila AI&trade;, you have the power to thrive in a world of synthetic
          content. Our technology aims to amplify what makes you extraordinary.
        </p>
      </PageIntro>
