        ...
        <Link href={`/use-cases/${slug}`}>
          <Card className="flex h-full flex-col justify-between p-6 transition hover:bg-muted sm:p-8">
            <CardHeader className="flex flex-col justify-between">
              ...
              <CardTitle className="line-clamp-2 font-display text-2xl font-semibold text-foreground">
                {title}
              </CardTitle>
            </CardHeader>
            <CardContent className="mt-4 line-clamp-4 text-base text-muted-foreground">
              {description}
            </CardContent>
            <CardFooter>
              <Button
                variant="outline"
                className="mt-8 w-full justify-between font-bold"
              >
                {buttonText}
  ...
  return (
    <>
      ...
      >
        ...
        <h3 className="mt-16 font-display text-xl font-semibold text-foreground lg:text-2xl">
      ...
      <Container className="mt-16">
        <h2 className="my-16 font-display text-xl font-semibold text-foreground lg:text-2xl">
